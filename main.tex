...
\newcommand{\csCompileTime}{08/2021}
...
%----- BEGIN MISSION (NHIEM VU LUAN VAN) -----%
\input{frontmatter/mission.tex}
...
\include{content/ch3-rust-embedded}
\include{content/ch4-application}
\include{content/ch5-ketluan}
