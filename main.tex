...
\usepackage[unicode, hidelinks]{hyperref} % Hypertext support, useful for making bookmarks and click-able hyperlinks
...
\pagestyle{fancy}
\fancyhf{}
\lhead{Đề cương luận văn - \csCompileTime}
...
\newcommand{\crname}{BÁO CÁO ĐỀ CƯƠNG LUẬN VĂN} % Thesis, report, whatever
