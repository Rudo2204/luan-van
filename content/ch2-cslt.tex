...
\subsubsection{Một số chức năng khác của \emph{cargo}}
...
%TODO: fix style of these flags to bash style
\begin{longtable}{r|l}
\textbf{Cờ} & \textbf{Mô tả} \\
\midrule
\endhead
-{}-target TARGET & Biên dịch cho đối tượng TARGET \\
-{}-features FEATURES & Biên dịch thêm các FEATURES trong đề tài \\
\bottomrule
...
\subsection{Hiệu suất thực thi và bộ nhớ}
