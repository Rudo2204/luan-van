...
\subsection{Một số khái niệm nâng cao}
...
\begin{longtable}{>{\raggedleft\arraybackslash}p{6cm}|p{8cm}  >{\raggedleft\arraybackslash}p{6cm}|p{8cm}}
...
\subsection{Cấu trúc một dự án trong Rust}
